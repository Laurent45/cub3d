...
#    Updated: 2022/10/13 14:44:40 by lfrederi         ###   ########.fr        #
#                                                                              #
# **************************************************************************** #
...
SRCS	= 	sources/main.c \
			...
			$(addprefix sources/Raycasting/, init.c raycasting.c create_img.c\
			...
			$(addprefix utils/, error.c utils.c utils1.c clear.c))
