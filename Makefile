...
#    Updated: 2022/10/13 09:23:41 by lfrederi         ###   ########.fr        #
#                                                                              #
# **************************************************************************** #
...
SRCS	= 	sources/main.c \
			...
			$(addprefix sources/Raycasting/, init.c utils.c utils2.c raycasting.c create_img.c error.c\
			$(addprefix draw/, draw_map.c draw_rectangle.c draw_segment.c draw_player.c draw_wall.c)\
